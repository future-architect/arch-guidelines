...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">└──</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> README.md</span></span></code></pre></div><h2 id="システム構成図" tabindex="-1">システム構成図 <a class="header-anchor" href="#システム構成図" aria-label="Permalink to &quot;システム構成図&quot;">​</a></h2><p>図は基本的に変更差分がGitと相性が良い、PlantUML（またはMermaid.js）で作成すること。PlantUMLの場合、テーマは <code>toy</code> を指定すること。</p><div class="language-plantuml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plantuml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">@startuml</span></span>
