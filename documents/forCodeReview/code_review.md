...
## 1. 重要な変更の場合、方向性を事前にチームと合意形成しておく
...
## 12. Files changedで余計なファイルがコミットされていないか確認する
...
## 15. Reviewers設定はレビュー依頼時にブランクで良い
...
## 5. 「Start a review」と「Add single comment」の使い分け
...
## 12. 指摘内容を論理的に説明できないのであれば、コメントすべきではない
...
## 14. 本筋から離れるコードコメントやREADMEのtypoなどはsuggestにする
...
## 15. nits（WANT以下）のコメントだけであれば、先にapproveする
...
## 19. ジュニアメンバーに対して大量の指摘がある場合にどうするか
