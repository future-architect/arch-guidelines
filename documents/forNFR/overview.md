...
ここで強調しておきたい。フレームワークは、大きな抜け漏れを防ぐための補完的な道具であって、それに沿って項目を上から埋めていくための台帳ではない。 よくある罠は、項目が並んでいるとつい頭から順に埋めたくなり、項目を消化することが目的化してしまうケースである本来は、本当に重要な要件を見落とさないよう、検討の抜けを点検するための網羅性チェックとして用いることである。優先順位づけの主役はシステム固有の重要ドライバ（→ [STEP4](#step4)）に据える。
