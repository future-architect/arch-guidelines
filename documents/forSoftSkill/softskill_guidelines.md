...
アーキテクトは専門性が高く、同時に本ドキュメントにあるようなソフトスキルも求められるため、必ずしも全ての開発者に適性があるわけではない。しかし、メンバーのスキル向上やキャリア実現を支援し、個人の成長を組織の成果に繋げることはそれとは直行した概念で重要である。

| 項目       | レベル1 (認識)                                                                                                                                                                                               | レベル2 (実践)                                                                                                           | レベル3 (指導)                                                                 |
| :--------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------- |
| コーチング | 後輩からの技術的な質問に対して、丁寧に回答する。コードレビューを通じて、メンバーに具体的なフィードバックを行い、その成長を支援できる。1on1を定期的に実施し、メンバーの課題や不満を引き出し、成長を支援する。 | メンバーのスキルやキャリア志向を理解し、適切な裁量とストレッチなタスクを渡すことができる                                 | \-                                                                             |
| 採用、評価 | 書類選考・採用面接を積極的に引き受ける。                                                                                                                                                                     | 採用面接官として、候補者のスキルやカルチャーフィットを適切に見極めための、判断基準を自分なりの視点で言語化、体系化する。 | チームや部署の採用計画を主導し、メンバーの評価や育成プランの策定に責任を持つ。 |
...
アーキテクトは技術的リーダーでもあるため、心理的安全性を高め、メンバーが自律的に挑戦し、相互に学び合う健全な組織風土を醸成することに主導的な立場で関与できる、ほぼ唯一の存在である。率先してオープンマインドした発言や振る舞い、自己研鑽する姿勢を見せることで健全な組織文化を育む。
