...
- 営業活動
  ...
  - 技術的な課題、悩み事項への助言、相談に応え建設的に議論することができる
- プロジェクトにおける技術的な意思決定を主体的に行える「できるプロジェクトリーダーシップ」を取ること
...
アーキテクトは、技術だけやっていれば良いのではなく、チーム内外の利害関係者と円滑に連携し、納得感のある合意形成を図ることが必要である。合意形成のためには相手の聞きたいことを捉え、相手の立場や知識レベルに合わせて分かるように論理的に組み立て要点を伝える必要がある。
